...
// "use client"
// import * as React from "react"
// import { ArrowLeft, Save, ArrowRight, CheckCircle, X, Plus, UserPlus } from "lucide-react"
// import { Button } from "@/components/ui/button"
...
//     id: string
//     description: string
//     assignedTo?: string  // Optionnel, pas de valeur par défaut
//     completed: boolean
//   }
// const TOTAL_STEPS = 5
...
//   const { data: members = [], isLoading: membersLoading } = useMembers(project?.companyId || null)
...
//   const [newMember, setNewMember] = React.useState({ name: "", email: "", role: "" })
//   const [formData, setFormData] = React.useState({
//     weekNumber: "",
//     startDate: "",
//     endDate: "",
//     summary: "",
//     tasks: [{ id: crypto.randomUUID(), description: "", assignedTo: undefined, completed: false }] as Task[],
//     blockers: [""],
//     nextWeekObjectives: [""]
//   })
...
//     setFormData(prev => ({
//       ...prev,
//       tasks: [...prev.tasks, { id: crypto.randomUUID(), description: "", assignedTo: undefined, completed: false }] // Changer "" en undefined
//     }))
//   }
...
//     }))
//   }
//   const addItem = (field: 'blockers' | 'nextWeekObjectives') => {
//     setFormData(prev => ({
//       ...prev,
//       [field]: [...prev[field], ""]
//     }))
//   }
//   const removeItem = (field: 'blockers' | 'nextWeekObjectives', index: number) => {
//     setFormData(prev => ({
//       ...prev,
//       [field]: prev[field].filter((_, i) => i !== index)
//     }))
//   }
//   const updateItem = (field: 'blockers' | 'nextWeekObjectives', index: number, value: string) => {
//     setFormData(prev => ({
//       ...prev,
...
//                 Résumez les accomplissements et activités principales de la semaine
//               </Label>
//               <Textarea
//                 id="summary"
...
//                     />
//                   </div>
//                   <Button onClick={handleCreateMember} disabled={isCreatingMember} className="w-full">
//                     {isCreatingMember ? "Ajout..." : "Ajouter"}
//                   </Button>
//                 </div>
//               </DialogContent>
//             </Dialog>
...
//   </SelectTrigger>
//   <SelectContent>
//     {/* Retirer cette ligne qui cause l'erreur:
...
function CreateReportView({ projectId }) {
    ...
    const { data: members = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$hooks$2f$use$2d$members$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMembers"])(companyId);
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                                            children: [
                                                                                ...
                                                                                members.map((member)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                                        value: member.id,
...
//# sourceMappingURL=Documents_TECH%20LEAD_project-tracking-tool_dfe7f2bd._.js.map