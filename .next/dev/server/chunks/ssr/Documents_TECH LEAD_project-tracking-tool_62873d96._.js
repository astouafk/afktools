...
// "use client"
// import { ArrowLeft, Edit, FileDown, Plus, X } from "lucide-react"
...
//         assignedTo: { name: "Mike Chen", role: "UI/UX Designer", initials: "MC", color: "bg-blue-500" },
//         status: "Completed",
...
//         assignedTo: { name: "Sarah Johnson", role: "Backend Developer", initials: "SJ", color: "bg-purple-500" },
//         status: "Completed",
//         comment: "—",
//       },
//       {
...
//         assignedTo: { name: "John Smith", role: "Frontend Developer", initials: "JS", color: "bg-blue-500" },
//         status: "In progress",
...
//     ],
//     notes:
//       "Overall good progress this week. The checkout flow redesign is coming together nicely. Main blocker is the API integration delay.",
//   }
//   return (
...
//           <h1 className="text-3xl font-semibold tracking-tight text-card-foreground">{report.title}</h1>
...
//         <CardHeader>
//           <CardTitle className="text-card-foreground">Objectifs de la semaine</CardTitle>
//         </CardHeader>
//         <CardContent>
...
//       <Card className="bg-card">
//         <CardHeader>
//           <CardTitle className="text-card-foreground">Taches Assignées</CardTitle>
//         </CardHeader>
//         <CardContent>
...
//                   <th className="text-left p-4 text-sm font-medium text-foreground">Taches</th>
//                   <th className="text-left p-4 text-sm font-medium text-foreground">Membre Assigné</th>
//                   <th className="text-left p-4 text-sm font-medium text-foreground">Statut</th>
//                   <th className="text-left p-4 text-sm font-medium text-foreground">Commentaire</th>
//                 </tr>
//               </thead>
//               <tbody>
...
//                   >
//                     <td className="p-4 text-sm text-foreground">{task.description}</td>
//                     <td className="p-4">
...
//                       </Badge>
//                     </td>
//                     <td className="p-4 text-sm text-muted-foreground">{task.comment}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
...
//           <h2 className="text-xl font-semibold text-foreground">Blockers</h2>
//           {!showBlockerForm && (
//             <Button onClick={() => setShowBlockerForm(true)} size="sm">
...
//               <CardTitle className="text-card-foreground">New Blocker</CardTitle>
//               <Button variant="ghost" size="icon" onClick={() => setShowBlockerForm(false)}>
//                 <X className="h-4 w-4" />
//               </Button>
//             </CardHeader>
//             <CardContent>
...
//                     <select className="w-full mt-1 px-3 py-2 bg-background border border-border rounded-md text-sm text-foreground">
...
//                 </div>
//                 <div className="flex gap-2">
//                   <Button size="sm">Save Blocker</Button>
//                   <Button size="sm" variant="outline" onClick={() => setShowBlockerForm(false)}>
//                     Cancel
//                   </Button>
//                 </div>
//               </div>
...
//               <Card key={blocker.id} className="bg-card border-destructive">
//                 <CardContent className="pt-6">
//                   <div className="rounded-lg border border-destructive/50 bg-destructive/5 p-4 space-y-2">
//                     <div className="flex items-start justify-between">
//                       <p className="text-sm font-medium text-foreground flex-1">{blocker.description}</p>
//                       <Badge variant={blocker.resolved ? "default" : "destructive"}>
//                         {blocker.resolved ? "Resolved" : "Unresolved"}
//                       </Badge>
//                     </div>
//                     <div className="grid grid-cols-2 gap-4 text-xs">
//                       <div>
//                         <span className="font-medium text-foreground">Source:</span>{" "}
//                         <span className="text-muted-foreground">{blocker.source}</span>
//                       </div>
//                       <div>
...
//                       <p className="text-xs text-muted-foreground mt-1">{blocker.actionTaken}</p>
//                     </div>
//                   </div>
//                 </CardContent>
//               </Card>
...
//       <Card className="bg-card">
//         <CardHeader>
//           <CardTitle className="text-card-foreground">Decisions Made</CardTitle>
//         </CardHeader>
//         <CardContent>
...
//       <Card className="bg-card">
//         <CardHeader>
//           <CardTitle className="text-card-foreground">Notes & Observations</CardTitle>
//         </CardHeader>
//         <CardContent>
...
function ReportDetailView({ projectId, reportId }) {
    ...
    const totalTasks = report.completedTasks.length + report.blockers.length;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            report.completedTasks.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardTitle"], {
                            children: "Tâches Complétées"
            ...
            report.blockers.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardTitle"], {
            ...
            report.nextWeekObjectives.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardTitle"], {
...
//# sourceMappingURL=Documents_TECH%20LEAD_project-tracking-tool_62873d96._.js.map