...
// }
// components/all-reports-view.tsx
// Vérifier que l'export est correct
__turbopack_context__.s([
    "AllReportsView",
    ()=>AllReportsView
]);
...
;
const ITEMS_PER_PAGE = 6;
// Récupérer les projets pour afficher les noms
...
function AllReportsView() {
    ...
    const [projectNames, setProjectNames] = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]({});
    // Charger les noms de projets depuis Firestore
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        const loadProjectNames = async ()=>{
            const uniqueProjectIds = Array.from(new Set(allReports.map((r)=>r.projectId)));
            // On va charger les noms de projets depuis Firestore
            const { getProjectsByIds } = await __turbopack_context__.A("[project]/Documents/TECH LEAD/project-tracking-tool/lib/services/project-service.ts [app-ssr] (ecmascript, async loader)");
            const projects = await getProjectsByIds(uniqueProjectIds);
            const names = {};
            projects.forEach((p)=>{
                names[p.id] = p.name;
            });
...
//# sourceMappingURL=Documents_TECH%20LEAD_project-tracking-tool_830e8d8f._.js.map