...
const getProjectsFromLocalStorage = ()=>{
    ...
    try {
        ...
        // On ne peut pas utiliser useProjects ici, on va créer un hook dédié
        return [];
    } catch  {
        return [];
    }
...
function AllReportsView() {
    ...
    const [projectNames, setProjectNames] = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({});
    // Charger les noms de projets depuis Firestore
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "AllReportsView.useEffect": ()=>{
            const loadProjectNames = {
                "AllReportsView.useEffect.loadProjectNames": async ()=>{
                    const uniqueProjectIds = Array.from(new Set(allReports.map({
                        "AllReportsView.useEffect.loadProjectNames.uniqueProjectIds": (r)=>r.projectId
                    }["AllReportsView.useEffect.loadProjectNames.uniqueProjectIds"])));
                    // On va charger les noms de projets depuis Firestore
                    const { getProjectsByIds } = await __turbopack_context__.A("[project]/Documents/TECH LEAD/project-tracking-tool/lib/services/project-service.ts [app-client] (ecmascript, async loader)");
                    const projects = await getProjectsByIds(uniqueProjectIds);
                    const names = {};
                    projects.forEach({
                        "AllReportsView.useEffect.loadProjectNames": (p)=>{
                            names[p.id] = p.name;
                        }
                    }["AllReportsView.useEffect.loadProjectNames"]);
...
_s(AllReportsView, "xUfcTRzJ4TPj7HpjpXeq5OYbR8g=", false, function() {
    return [
...
//# sourceMappingURL=Documents_TECH%20LEAD_project-tracking-tool_3c8e7773._.js.map