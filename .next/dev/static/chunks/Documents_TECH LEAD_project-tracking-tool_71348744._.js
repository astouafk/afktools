...
async function updateReport(params) {
    ...
    if (params.data.status === 'Published') {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$TECH__LEAD$2f$project$2d$tracking$2d$tool$2f$lib$2f$services$2f$project$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateProjectProgress"])(params.projectId);
    }
    console.log('[Report Service] Report updated');
}
...
//# sourceMappingURL=Documents_TECH%20LEAD_project-tracking-tool_71348744._.js.map