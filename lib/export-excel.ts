...
//   const { reports, projects, members, period } = params
...
//     { wch: 12 }, // Date début
//     { wch: 12 }, // Date fin
//     { wch: 14 }, // Tâches totales
//     { wch: 16 }, // Tâches complétées
//     { wch: 16 }, // Taux complétion
//     { wch: 10 }, // Blocages
//     { wch: 12 }, // Statut
//   ]
...
//   const fileName = generateFileName('excel', period, projects)
...
//     return `export-${projectName}-${periodLabel}-${date}.${type === 'excel' ? 'xlsx' : 'pdf'}`
//   }
  
//   return `export-tous-projets-${periodLabel}-${date}.${type === 'excel' ? 'xlsx' : 'pdf'}`
// }
